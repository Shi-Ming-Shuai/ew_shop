...
// vant
import { Form, Field, Sidebar, Cell, CellGroup, Tag, Card, SidebarItem, Collapse, CollapseItem, List, Badge, Lazyload, Tab, Tabs, Button, Tabbar, TabbarItem, Icon, NavBar, Swipe, SwipeItem } from 'vant'
